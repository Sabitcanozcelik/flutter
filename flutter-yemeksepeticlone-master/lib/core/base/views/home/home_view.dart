                      ...
                      child: Column(
                        children: [
                          ListTile(
                            ...
                            title: const Text(" Döner",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold),),
                            subtitle: const Text("Döner - Merkez ",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.normal),),
                          ),
                          const Divider(),
                          Row(
                            children: [
